...
public class WinChoice extends WinBase{
	...
	public WinChoice(EventManager mainGame,JFrame frame) {
		...
		textpanel.setBounds(146, 13, 811, 338);
		...
		panela.setBounds(149, 385, 184, 37);
		...
		panelb.setBounds(146, 440, 194, 38);
		...
		panelc.setBounds(146, 491, 194, 37);
		...
		paneld.setBounds(167, 541, 150, 40);
		...
		panele.setBounds(146, 594, 194, 40);
