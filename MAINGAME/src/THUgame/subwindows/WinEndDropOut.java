...
public class WinEndDropOut extends WinBase{
	 ...
	 * 
	 *************************************************************/
	static private class EndDropOutListener extends BaseMouseListener{
		...
		public EndDropOutListener(int i){
			this.mode=i;
		}
	 ...
	 * 
	 *************************************************************/
	public WinEndDropOut(EventManager mainGame,JFrame frame)  {
		...
		JPanel backgroundImage=new ImagePanel("imgsrc//WinEndNormal/Failed.png",0, 0, 1080, 720);
		...
		{
		case 0:
			dialogContent.setText("<html>清华大学非常重视学生的学习情况和学风建设，对学生在学习层面有基本的要求。</html>");
			break;
		case 1:
			dialogContent.setText("<html>你因挂科过多，未达到学校要求，惨遭退学。</html>");
			break;
		case 2:
			dialogContent.setText("<html>你走向未知的未来，不过，或许重来一次，你能做得更好？</html>");
			break;
		case 3:
			dialogContent.setText("<html>>>>>>游戏结束，你达成结局：【惨遭退学】<<<<<<</html>");
			break;
		 ...
		 * 【鼠标动作的设置】
		 ********************************************/
		EndDropOutListener.dataPackage=dataPackage;//数据包注册，不需要改
		EndDropOutListener.mainGame=mainGame;
		EndDropOutListener click=new EndDropOutListener(0);//设置鼠标监听器，发生0号事件
