	...
	public WinSTA(EventManager mainGame,JFrame frame) {
		...
		dialogPack.setLayout(null);
			...
			if (!dataPackage.notification.equals(""))//设置对话内容
				...
				dialogContent.setText("<html>终于到了遥远的科创实验室～看看我要做什么，学3D打印？激光切割？还是整理工具台？<br>现在我"
						+ "对科协对贡献为："+dataPackage.contibuteSTA+"/100，"
								+ "我的科创能力值为"+dataPackage.contibuteSTA+"<br>"
										+ "这些对我以后参与比赛、挑战杯、科研以及竞选骨干一定都有帮助呢</html>");//设置默认对话内容
		...
		JPanel Background=new ImagePanel("imgsrc//WinSTA/640"+dataPackage.stateA+".jpeg",0, 0, 1080, 720);
		//JPanel Background=new ImagePanel("imgsrc//WinSTA/640.jpeg",0, 0, 1080, 720);
		...
		demoMouseListener clickBack=new demoMouseListener(3);//设置鼠标监听器，发生2号事件
