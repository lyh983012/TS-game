...
public class WinSTA extends WinBase{
	...
	public WinSTA(EventManager mainGame,JFrame frame) {
		...
		//¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥这部分不允许改¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥
		JButton doChallenge = new JButton();  //zwj
		doChallenge.setBorderPainted(false);
		doChallenge.setBounds(870, 400, 150, 50);
		doChallenge.setContentAreaFilled(false);
		setIcon("/imgsrc/Challenge/zuotiaozhanbei.png",doChallenge);
		setSelectedIcon("/imgsrc/Challenge/zuotiaozhanbei_press.png",doChallenge);
		
		backgroundPanel.add(doChallenge);
		doChallenge.setVisible(false);
		if(dataPackage.joinChallengeCup && dataPackage.stateA.equals("")) {
			doChallenge.setVisible(true);
		}
     		demoMouseListener clickdochal=new demoMouseListener(10);
       	                clickdochal.setButton(doChallenge);
		doChallenge.addMouseListener(clickdochal);//10号事件是 做挑战杯 被点击
