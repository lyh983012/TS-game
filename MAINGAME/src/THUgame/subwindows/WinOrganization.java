	...
	public WinOrganization(EventManager mainGame,JFrame frame) {
		...
		if (dataPackage.count == 3) {
			...
			choosePack.setLayout(null);
				...
				chooseImagePanel.setOpaque(false);
					...
					refuseButton.setFont(new Font("Dialog", Font.BOLD, 16));
		...
		if (dataPackage.count == 4 && dataPackage.stateA.equals("continueEnroll")) {
			...
			enrollPack.setLayout(null);
				...
				enrollPanel.setBorder(new LineBorder(new Color(0, 0, 0), 2));
				enrollPanel.setBackground(new Color(255, 248, 220));
			...
			// TODO: background image of questionnaire
				...
				JLabel enrollWordLabel = new JLabel("你想加入的学生组织有？");
				...
				enrollChoiceGroup.setBounds(36, 177, 30, 100);
					...
					STAlabel.setBounds(63, 203, 120, 25);
				...
				JLabel reasonTitle = new JLabel("你的理由是？");
