...
public class WinEndProgrammer extends WinBase{
	 ...
	 * 
	 *************************************************************/
	static private class EndProgrammerListener extends BaseMouseListener{
		...
		public EndProgrammerListener(int i){
			this.mode=i;
		}
	 ...
	 * 
	 *************************************************************/
	public WinEndProgrammer(EventManager mainGame,JFrame frame)  {
		...
		{
		case 0:
			dialogContent.setText("<html>毕业后，你进入一家互联网企业工作，成为了一名程序员，也称码农。</html>");
			break;
		case 1:
			dialogContent.setText("<html>你被要求按996上班，用辛苦的工作换取工资。</html>");
			break;
		case 2:
			dialogContent.setText("<html>大学时经历的一些编程训练似乎对你有些帮助，但为不被淘汰，你需要抓紧少有的空余时间学习新技术。</html>");
			break;
		case 3:
			dialogContent.setText("<html>在放下手机后的深夜，你常常自嘲自己正在被榨取相当多的剩余价值，却无能为力。</html>");
			break;
		case 4:
			dialogContent.setText("<html>如果再来一次，是否一切都会不同？</html>");
			break;
		case 5:
			dialogContent.setText("<html>>>>>>游戏结束，你达成结局：【码农】<<<<<<</html>");
			break;
		 ...
		 * 【鼠标动作的设置】
		 ********************************************/
		EndProgrammerListener.dataPackage=dataPackage;//数据包注册，不需要改
		EndProgrammerListener.mainGame=mainGame;
		EndProgrammerListener click=new EndProgrammerListener(0);//设置鼠标监听器，发生0号事件
