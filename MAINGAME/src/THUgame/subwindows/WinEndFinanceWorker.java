...
public class WinEndFinanceWorker extends WinBase{
	 ...
	 * 
	 *************************************************************/
	static private class EndFinanceWorkerListener extends BaseMouseListener{
		...
		public EndFinanceWorkerListener(int i){
			this.mode=i;
		}
	 ...
	 * 
	 *************************************************************/
	public WinEndFinanceWorker(EventManager mainGame,JFrame frame)  {
		...
		{
		case 0:
			dialogContent.setText("<html>毕业后，你毅然选择了转向金融行业，最终成为该领域的从业者。</html>");
			break;
		case 1:
			dialogContent.setText("<html>很多人都说金融行业好，你看起来也像一个成功人士，但你清楚，你不过只是一个给资本辛苦打工的工具人而已。</html>");
			break;
		case 2:
			dialogContent.setText("<html>大学时，你也曾与同学开过“一切专业转金融”的玩笑，没想到现在你自己也成为了笑谈中的一员。</html>");
			break;
		case 3:
			dialogContent.setText("<html>你知道资本的机制、手段、丑恶之处，却也知道它在当前阶段的作用；你知道自己只不过在被利用，但也满足于用这种方式谋生。</html>");
			break;
		case 4:
			dialogContent.setText("<html>如果再来一次，是否一切都会不同？</html>");
			break;
		case 5:
			dialogContent.setText("<html>>>>>>游戏结束，你达成结局：【金融从业者】<<<<<<</html>");
			break;
		 ...
		 * 【鼠标动作的设置】
		 ********************************************/
		EndFinanceWorkerListener.dataPackage=dataPackage;//数据包注册，不需要改
		EndFinanceWorkerListener.mainGame=mainGame;
		EndFinanceWorkerListener click=new EndFinanceWorkerListener(0);//设置鼠标监听器，发生0号事件
