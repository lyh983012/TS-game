    		...
    		switch(dataPackage.ID) {
    			...
    			case 0://dom界面
    				if(dataPackage.choiceA.equals("gooutside")
    						...
    						||dataPackage.choiceA.equals("go_to_SA")
    						){
    					dataPackage.ID=3;
    				}
    				...
    				if(dataPackage.choiceA.equals("Chalsignup")) {
    					dataPackage.ID=61001;//zwj
    				}
				...
				case 2://下午界面
					...
					break;	
				case 3://MAP
					System.out.println(dataPackage.choiceA);
					...
					}else if(dataPackage.choiceA.equals("clickGoToDabian")){
						dataPackage.ID=61002;	//zwj
				...
				case 50007:
					dataPackage.ID=3;//进入map
					break;
				case 61001://挑战杯报名 zwj,报名完就回来
					dataPackage.ID=0;
					break;
				case 61002://挑战杯答辩 zwj,答辩完就回来
					dataPackage.ID=0;
					break;
