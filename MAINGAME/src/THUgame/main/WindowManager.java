...
import THUgame.subwindows.WinDabianClass;
...
import THUgame.subwindows.WinInDom2;
...
public class WindowManager extends JFrame {
	...
	public WindowManager(){
		 ...
		 ******************************************************************/
		/*		START OF YOUR CODE		*/
		WinBase.dataPackage=dataPackage;
		/*		END OF YOUR CODE		*/
	}
	...
	public void repaint(){
		...
		switch(dataPackage.ID) {
			...
			case 8:
				...
				break;
			case 9:
				generator = new WinExam(mainGame,mainFrame);
				break;
			case 20001:
			...
			case 50007:
				...
				break;
			case 61001:
				generator = new WinInDom2(mainGame, mainFrame);
				break;
			case 61002:
				generator = new WinDabianClass(mainGame, mainFrame);
				break;
