...
public class WinWelcome extends WinBase{
	...
	public WinWelcome(EventManager mainGame,JFrame frame) {
		...
		JPanel backgroundImage=new ImagePanel("imgsrc//WinWelcome/Welcome.png",0, 0, 1080, 720);
		backgroundImage.setBounds(0, 0, 1080, 720);
		backgroundImage.setOpaque(false);
		backgroundImage.setLayout(null);
		
		JPanel buttonImage = new ImagePanel("imgsrc//WinWelcome/Confirm.png",0,0,100,100);
		buttonImage.setBounds(0, 0, 100, 100);
		buttonImage.setOpaque(false);
		buttonImage.setLayout(null);
		...
		textLabel.setBounds(150, 172, 779, 278);
		...
		case 0:
			...
			if(isAdded == false) {
				text = text + "你在高中专心学业，对大学里的新事物抱有好奇和期待。<br>";
			}
			text = text + "在这里，你会遇到丰富多彩的事件、各种各样的同学、做出不同的选择。<br>短短几个学期之后，你会走向何方？";
