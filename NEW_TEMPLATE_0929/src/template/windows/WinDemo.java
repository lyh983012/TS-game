 ...
 **/
	 ...
	 * 
	 *************************************************************/
public class WinDemo extends WinBase{

	public WinDemo(EventManager mainGame,JFrame frame) {
		/*************************************************************	
		 *
		...
		if (!dataPackage.stateA.equals(dataPackage.stateA))
...
class demoMouseListener implements MouseListener{
